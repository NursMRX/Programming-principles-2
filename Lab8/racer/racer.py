...
backgraund = pygame.image.load("/home/nursultan/Projects python/PP2/Lab8/racer/AnimatedStreet.png")
...
class coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/home/nursultan/Projects python/PP2/Lab8/racer/coin.png")
    ...
    def empty_space(self):
        while True:
            self.rect.center = (random.randint(40, SCREEN_WIDTH-40), random.randint(100, SCREEN_HEIGHT-80))
            if not any(pygame.sprite.collide_rect(self, entity) for entity in enemy_and_player):
                break
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/home/nursultan/Projects python/PP2/Lab8/racer/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("/home/nursultan/Projects python/PP2/Lab8/racer/Player.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("/home/nursultan/Projects python/PP2/Lab8/racer/crash.wav").play()
        time.sleep(0.5)
